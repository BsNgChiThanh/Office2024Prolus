...
- ĐẦU TIÊN KÍCH HOẠT BẰNG KEY KMS 180 NGÀY:
  - Dùng [file cmd](https://github.com/BsNgChiThanh/Office2024Prolus/blob/IMP/ActiveOffice2024Prolus.cmd) hoặc chạy **cmd** bằng quyền **Run as Administrator** rồi dán đoạn lệnh này vào, nhấn enter:
  ```PHP
  set v=16
